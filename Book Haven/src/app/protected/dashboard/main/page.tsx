...
const MainPage = () => {
  return (
    <main className="text-gray-600 body-font items-center  ">
      <div className="h-screen flex flex-col justify-center items-center bg-gradient-to-r from-blue-300 to-purple-200">
        <div className="relative bg-white rounded-lg p-8 rounde-lg border-6 border-dashed border-lightgray shadow-lg bg-gradient-to-r from-blue-300 to-purple-200">
